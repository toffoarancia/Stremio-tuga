  ...
  return new Promise(async (resolve) => {
    ...
    try {
      ...
      page.on('request', req => {
        ...
        if (['image', 'font', 'media'].includes(rt)) return req.abort();
        // Block ad networks including TikTok ads
        const adHosts = ['googlesyndication','doubleclick','amazon-adsystem','tiktokcdn','tiktok.com','imasdk.googleapis','googleads','adnxs','taboola','outbrain'];
...
app.get('/debug-child-m3u8', async (req, res) => {
  ...
  try {
    ...
    // Wait 30 seconds to capture ad + real stream
    await new Promise(r => setTimeout(r, 30000));
    res.json({ embedUrl, allRequests });
  } catch(e) {
